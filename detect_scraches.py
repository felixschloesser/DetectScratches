...
from lib.image_lib import load_img, show_img, show_hist, resize_img, save_img, img_list
from lib.edge_lib import threshold, get_points, overlay_points
from lib.crop_lib import mark_region, fit_lines, find_intersections, warp_to_corners
...
files = img_list("/home/tintin/rongheng/cv/test_images")

for file in files:
    raw_img = load_img(file, size=(300, 400))
